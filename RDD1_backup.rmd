...
### Panel A
```{r}
rdplot(hansen$acc, hansen$bac1, p = 2, c = 0.08, title = "Accidents & BAC", y.label = 'Accident', x.label = 'BAC', kernel = "triangular", x.lim = c(0,0.25), y.lim = c(0,0.2))
```

### Panel B
```{r}
rdplot(hansen$male, hansen$bac1, p =1, c = 0.08, title = "Male & BAC", y.label = 'Male', x.label = 'BAC', kernel = "triangular", x.lim = c(0,0.2), y.lim = c(0.74,0.82))
```

### Panel C
```{r}
rdplot(hansen$aged, hansen$bac1, p =2, c = 0.08, title = "Age & BAC", y.label = 'Age', x.label = 'BAC', kernel = "triangular", x.lim = c(0,0.2), y.lim = c(34,38))
```

### Panel D
```{r}
rdplot(hansen$white, hansen$bac1, p =1, c = 0.08, title = "White & BAC", y.label = 'White', x.label = 'BAC', kernel = "triangular", x.lim = c(0,0.2), y.lim = c(0.8,0.9))
```
